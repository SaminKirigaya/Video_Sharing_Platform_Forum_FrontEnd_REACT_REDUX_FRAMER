...
function SearchBasedOnTag() {
  ...
  return (
    ...
    <div className='container-fluid pages flex-column'>
        ...
        <h5 className='mx-auto text-center mt-4 mb-4 welcomeTxt'>Category - "{searchText[0].toLocaleUpperCase()+searchText.slice(1,searchText.length)}" ...</h5>

        <div className='row row-cols-1 row-cols-md-4 mb-5 d-flex justify-content-start p-3'>

          {oldVideos ? showAllOldVideosInCard() : <div className='d-flex mx-auto w-100 justify-content-center'><p className='mx-auto fontcol'>No such video matches according to your Category ... 😖</p></div>}
          {oldVideos.length<1 ? <div className='d-flex mx-auto w-100 justify-content-center'><p className='mx-auto fontcol'>Some Error Occured Or It Seems The Server Has No Video Uploaded According To Your Category ... 😖</p></div>:null}
